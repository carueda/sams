...
/**
 * Computes the minimim from various signatures.
 * @author Carlos A. Rueda
 * @version $Id$ 
 */
public class MinimumOperation implements IMultiSignatureOperation
{
	...
	{
		return "Computes the minimum";
	}

	/**
	 * Computes the minimum from various signatures.
